...
frappe.ui.form.on('Mitglieder Rechnungslauf', {
	refresh: function(frm) {
		if (!cur_frm.is_new()) {
			...
			cur_frm.set_intro(__("Speichern Sie diesen Rechnungslauf um alle auslaufenden Mitgliedschaften zu laden."));
		}
	}
});
