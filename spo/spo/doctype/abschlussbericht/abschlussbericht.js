...
function set_titelzeile(frm, mandat) {
    if (!cur_frm.doc.titel_textkonserve) {
        if (!cur_frm.doc.titelzeile||cur_frm.doc.titelzeile=="<div><br></div>") {
            frappe.call({
                "method": "spo.spo.doctype.abschlussbericht.abschlussbericht.get_titelzeile",
                "args": {
                    "adresse": mandat.adresse,
                    "kontakt": mandat.kontakt,
                    'referenz': mandat.rechtsschutz_ref
                },
                "async": false,
                "callback": function(r) {
